          ...
          if (product.description) {
            if (product.trailer) {
             ...
             this.data.error('Please enter description.');
              ...
              this.data.error('Please enter trailer Url.');
               }
             } else {
             this.data.error('Please enter straming Url.');
             }
             } else {
             this.data.error('Please enter download Url.');
             }
            } else {
              this.data.error('Please enter evaluation value.');
              }
             } else {
             this.data.error('Please select category.');
             }
             } else {
             this.data.error('Please enter a year.');
             }
             } else {
